...
_creatures = [
    ...
    Creature(name="Sasquatch",aka="The Scream", country="US", area="*All*", description="Yeti's cousin"),
    Creature(name="Bigfoot",aka="Sasquatch", country="US", area="*All*", description="Yeti's cousin"),
]
